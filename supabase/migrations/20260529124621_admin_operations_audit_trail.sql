create table if not exists public.admin_audit_events (
  ...
  constraint admin_audit_events_type_valid check (
    event_type = any (array[
      'provider_reviewed'::text,
      'platform_fee_changed'::text,
      'payment_verified'::text,
      'payment_rejected'::text,
      'payout_paid'::text
    ])
  ),
  constraint admin_audit_events_entity_valid check (
...
create policy "Admins can insert own admin audit events"
  on public.admin_audit_events
  for insert
  to authenticated
